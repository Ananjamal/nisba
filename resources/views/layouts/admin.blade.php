...
<body class="antialiased bg-gray-50 font-cairo"
    ...
    <div class="min-h-screen bg-gray-50 flex flex-row-reverse relative">
        ...
        <aside class="hidden lg:flex flex-col fixed inset-y-0 right-0 z-20 bg-primary-900 shadow-2xl transition-all duration-300 overflow-y-auto border-l border-white/10"
