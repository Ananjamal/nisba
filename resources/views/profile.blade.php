            ...
            <div class="lg:col-span-4 space-y-6">
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="grid grid-cols-1 gap-4">
                            <div class="p-4 bg-bg-main rounded-2xl flex items-center justify-between">
                                <div>
                                    <p class="text-xs text-secondary mb-1">حالة الحساب</p>
                                    <span class="badge badge-active">نشط</span>
                                </div>
                                <div class="text-primary-900 font-black">✓</div>
                            </div>
                            <div class="p-4 bg-bg-main rounded-2xl flex items-center justify-between">
                                <div>
                                    <p class="text-xs text-secondary mb-1">نسبة العمولة</p>
                                    <p class="text-lg font-black text-primary-900">20%</p>
                                </div>
                                <div class="text-secondary font-black">%</div>
                            </div>
                            <div class="p-4 bg-bg-main rounded-2xl flex items-center justify-between">
                                <div>
                                    <p class="text-xs text-secondary mb-1">تاريخ التسجيل</p>
                                    <p class="text-sm font-bold text-primary-900">{{ auth()->user()->created_at->format('Y/m/d') }}</p>
                                </div>
                                <div class="text-secondary font-black">📅</div>
                            </div>
                        </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body space-y-4">
                        <div class="flex items-center justify-between p-4 bg-bg-main rounded-2xl">
                            <div>
                                <p class="font-bold text-primary-900">الرسائل</p>
                        ...
                        <div class="flex items-center justify-between p-4 bg-bg-main rounded-2xl">
                            <div>
                                <p class="font-bold text-primary-900">حالة العملاء</p>
                        ...
                        <div class="flex items-center justify-between p-4 bg-bg-main rounded-2xl">
                            <div>
                                <p class="font-bold text-primary-900">طلبات الصرف</p>
